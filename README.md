...
Calculates Gelfond-Schneider Constant to an arbitrary precision of [N] significant digits using a highly optimized 12-core parallelized algorithm.
...
```bash
python "Gelfond-Schneider Constant.py" -n 1000
```
